...
@Component({
  selector: "app-achievement-template-print",
  templateUrl: "./achievement-template-print.component.html",
  styleUrls: ["./achievement-template-print.component.css"],
})
export class AchievementTemplatePrintComponent implements OnInit {

...
export class ParticipantTemplateComponent implements OnInit {
  ...
  calElementSize() {
    ...
    this.fitText(document.getElementsByClassName("d-text-1"), 1.525);
    this.fitText(document.getElementsByClassName("d-text-2"), 1.225);
    this.fitText(document.getElementsByClassName("d-text-3"), 2.35);
  }
